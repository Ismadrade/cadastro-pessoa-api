...
public interface PessoaRepository extends JpaRepository<Pessoa, Long> {
	...
	List<Pessoa> findPessoaByName(String pessoa);
	...
	List<Pessoa> findPessoaByNameSexo(String pessoa, String sexopessoa);
	...
	default Page<Pessoa>findPessoaByNamePage(String nome, Pageable pageable){
		...
		/*Configurando pesquisa para coonsultar por partes do nome no banco de dados, igual a like do sql*/
