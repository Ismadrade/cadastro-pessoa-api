...
public class PessoaController {
	...
	public void baixarcurriculo(@PathVariable("idpessoa") Long idpessoa, HttpServletResponse response) throws IOException {
		/*Consultar objeto pessoa do banco de dados*/
	...
	public void imprimePdf(@RequestParam("") String nomepesquisa, @RequestParam("pesqsexo") String pesqsexo,
		...
		byte[] pdf = reportUtil.geraRelatório(pessoas, "pessoa", request.getServletContext());
